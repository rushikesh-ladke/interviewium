      ...
      <div className={styles.secondsection}>
        <div className='d-flex justify-content-between'>
          <div className={styles.careerRole}>
            ...
            <p><strong>Patreon</strong> - londontown, MD.</p>
          </div>
          <div className={styles.careerRole}>
            ...
            <p>Posted 8 Days ago <strong>98 Applicants</strong></p>
          </div>
        </div>
        ...
        <div className={styles.detailJob}>
          ...
          <ul>
            <li>a reader will be distracted by the readable content of a page wh</li>
            <li>a reader will be distracted by the readable content of a page wh</li>
            <li>a reader will be distracted by the readable content of a page wh</li>
          </ul>
        </div>
