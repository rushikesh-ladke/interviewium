            ...
            <div className='col-lg-8'>
              <div className={styles.DetailsMain}>
                ...
                <div className={styles.userPoint}>
                  Restructured a plotting algorithm for a printing platform
                  allowing paid 50K+ users to plot
                  <br />
                ...
                <div className={styles.StackExp}>
                  ...
                  <h6>
                    <strong>Languages: </strong>Lorem Ipsum is simply dumm
                  </h6>
                  <h6>
                    <strong>Frontend Libraries & Frameworks: </strong>Lorem
                    Ipsum is simply dumm
                  </h6>
                  <h6>
                    <strong>Backend Libraries & Frameworks: </strong>Lorem Ipsum
                    is simply dumm
                  </h6>
                  <h6>
                    <strong>Databases: </strong>Lorem Ipsum is simply dumm
                  </h6>
                  <h6>
                    <strong>Testing: </strong>Lorem Ipsum is simply dumm
                  </h6>
                  <h6>
                    <strong>Cloud: </strong>Lorem Ipsum is simply dumm
                  </h6>
                  <h6>
                    <strong>Mobile App Development: </strong>Lorem Ipsum is
                    simply dumm
                  </h6>
                </div>
                ...
                <div className={styles.profExp}>
                  ...
                  <div className={styles.info}>
                    <h5>
                      Invimatic Solutions, Pune(India) - Software Engineer
                    </h5>
                    ...
                    <div className={styles.infoStack}>
                      <p>
                        Tech Stack: React, Nextjs, Gatsby, Nextjs, HTML, and
                        SaSS
                      </p>
                      <ul>
                        <li>
